...
### Покращення UX тренувань

- [ ] Суперсети / гігантські сети — групування вправ у суперсет
- [ ] Копіювання минулого тренування — "Повторити тренування" одним тапом
- [ ] Нотатки до вправи — як себе почував, болі, техніка
- [ ] Drag & drop порядок вправ у логері
- [ ] Warm-up sets — окрема мітка для розминкових підходів (не рахуються в обсяг)

### Аналітика / прогрес

- [ ] Personal Records (PRs) — автоматичне відстеження рекордів (макс вага, макс об'єм, макс reps) з бейджами
- [ ] Streak counter — серія тренувань без пропусків
- [ ] Weekly/monthly звіти — автосаммарі: "Цього тижня +12% об'єм на спину"
- [ ] Heatmap тренувань — GitHub-style календар активності
- [ ] Порівняння періодів — "цей місяць vs минулий"

### Соціальне

- [ ] Шерінг тренування — генерація картинки-саммарі для stories
- [ ] Публічний профіль — опціонально показувати статистику

### Зручності

- [ ] Plate calculator — скільки блінів вішати на штангу
- [ ] Unit toggle — кг ↔ lbs перемикач
- [ ] Темна/світла тема toggle
- [ ] Швидкий старт — "Почати як минулого разу" на dashboard
- [ ] Таймер тренування — загальна тривалість на екрані

### Геміфікація

- [ ] Ачівки/бейджі — "100 тренувань", "Перший PR", "Тижневий streak x4"
- [ ] Рівні — прогрес-бар на основі загального об'єму
