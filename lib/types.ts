...
export type SetData = Pick<Set, "id" | "set_number" | "weight" | "reps" | "rpe" | "duration_s" | "exercise_id">;
export type ExerciseData = Pick<Exercise, "id" | "name" | "muscle_group" | "equipment">;
export type WorkoutWithSets = Pick<Workout, "id" | "name" | "started_at" | "finished_at" | "notes"> & {
  sets: SetData[];
};
