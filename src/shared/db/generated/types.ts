...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      exercise_muscles: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "exercise_muscles_muscle_key_fkey"
            columns: ["muscle_key"]
            isOneToOne: false
            referencedRelation: "anatomical_muscles"
            referencedColumns: ["key"]
          },
        ]
      }
    ...
    CompositeTypes: {
      ...
      dashboard_data: {
        profile:
          | Database["public"]["CompositeTypes"]["dashboard_profile"]
          | null
        recent_workouts:
          | Database["public"]["CompositeTypes"]["dashboard_recent_workout"][]
          | null
        week_stats:
          | Database["public"]["CompositeTypes"]["dashboard_week_stats"]
          | null
        prev_week_stats:
          | Database["public"]["CompositeTypes"]["dashboard_week_stats"]
          | null
        calendar_workouts:
          | Database["public"]["CompositeTypes"]["dashboard_calendar_workout"][]
          | null
        streak: number | null
      }
      dashboard_profile: {
      ...
      progress_period_summary: {
        stats:
          | Database["public"]["CompositeTypes"]["progress_period_stats"]
          | null
        muscle_tonnage:
          | Database["public"]["CompositeTypes"]["progress_muscle_tonnage"][]
          | null
        top_exercises:
          | Database["public"]["CompositeTypes"]["progress_top_exercise"][]
          | null
      }
